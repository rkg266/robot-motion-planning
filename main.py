...
#### USER EDITABLE
USE_Algo = 0 # 0: Astar, 1: RRT
res = 0.5 # Resolution for disretizing the 3-D space
####
...
def runtest(mapfile, start, goal, verbose = True):
  ...
  MP = Planner.MyPlanner(boundary, blocks, start, goal) # TODO: replace this with your own planner implementation
  #res = 0.5
  MP.discretize(res, start, goal)
  ...
  if path is not None:
    ...
    collision = MP.check_collision(path)
